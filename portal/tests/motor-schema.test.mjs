...
test('motor migration is additive and versioned', () => {
  ...
  for (const table of ['companies','company_users','activity_dependencies','activity_baselines','blockers','workers','teams','allocations','daily_reports','daily_report_workers','productivity_records','occurrences','safety_requirements','activity_safety_requirements','documents','document_versions','operational_reports','municipal_workflows','municipal_workflow_steps','project_administrative_steps']) {
